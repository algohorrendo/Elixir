      ...
      <div className="checkout-content">
        ...
        {carrito.length > 0 && (
          <div className="pago-section">
                ...
                <label className="pago-option">
                  ...
                  <span className="option-content">
                    ...
                    <span className="option-text">
                      ...
                      <small>Pago en la entrega</small>
                    </span>
                  </span>
                </label>
              </div>
            ...
            {metodo_pago === 'tarjeta' && (
              <div className="metodo-info">
                <div className="info-box warning-info">
                  <h4>💳 Opción en Desarrollo</h4>
                  <p>
                    Este método estará disponible próximamente.
                    Por ahora, selecciona <strong>Transferencia Bancaria</strong> o <strong>Pago en Efectivo</strong>.
                  </p>
                </div>
              </div>
            )}
            ...
            {metodo_pago === 'efectivo' && (
              <div className="metodo-info">
                <div className="info-box info">
                  ...
                  <p>
                    Se te mostrará la información de tu pedido y podrás proceder al pago en la entrega.
                  </p>
                  <ul>
                    <li>Verifica los detalles de tu compra</li>
                    <li>El producto será entregado en la dirección registrada</li>
                    <li>Paga directamente al recibir</li>
                  </ul>
                </div>
              </div>
            )}
