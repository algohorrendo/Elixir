...
function DashboardAdmin() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      // Obtener datos del dashboard gerente para estadísticas de ventas
      ...
      if (clientesData && clientesData.clientes) {
        ...
        if (dashboardData && dashboardData.estadisticas) {
          ventasTotales = dashboardData.estadisticas.total_ventas || 0;
          totalPedidos = dashboardData.estadisticas.total_pedidos || 0;
        }
